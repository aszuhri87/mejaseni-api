        ...
        var _componentPage = function(){
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render : function(data, type, full, meta) {
                                return `
                                    <a href="{{url('/admin/cms/faq')}}/${data}" title="Edit" class="btn btn-edit btn-sm btn-clean btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{url('/admin/cms/faq')}}/${data}" title="Delete" class="btn btn-delete btn-sm btn-clean btn-icon" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"/>
            ...
            initAction = () => {
                $(document).on('click', '#add-btn', function(event){
                    ...
                    $('#form-faq').attr('action','{{url('admin/cms/faq')}}');
                    $('#form-faq').attr('method','POST');
                ...
                $(document).on('click', '.btn-edit', function(event){
                    ...
                    $('#form-faq').trigger("reset");
                    $('#form-faq').attr('action', $(this).attr('href'));
                ...
                $(document).on('click', '.btn-delete', function(event){
                    ...
                    Swal.fire({
                        title: 'Delete FAQ?',
                        text: "Deleted FAQ will be permanently lost!",
                        icon: 'warning',
