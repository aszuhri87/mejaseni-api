        ...
        var _componentPage = function(){
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render : function(data, type, full, meta) {
                                return `<img src="${data}" class="viewer-img rounded" width="285" height="50">`
                            }
                        },
                        {
                            targets: -1,
                            ...
                            render : function(data, type, full, meta) {
                                return `
                                    <a href="{{url('/admin/cms/banner/update')}}/${data}" title="Edit" class="btn btn-edit btn-sm btn-clean btn-icon mr-2" title="Edit details">
            ...
            initAction = () => {
                ...
                $(document).on('click', '.btn-edit', function(event){
                    ...
                    $('#form-banner').attr('action', $(this).attr('href'));
                    $('#form-banner').attr('method','POST');

                    $('#form-banner').find('input[name="title"]').val(data.title);
                    $('#form-banner').find('textarea[name="description"]').val(data.description);
                    $('#image').empty();
