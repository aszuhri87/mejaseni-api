    ...
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div class="my-title d-flex align-items-center">
                <a href="{{url('admin/schedule')}}" class="btn btn-outline-danger btn-sm btn-list-view mr-2">Kembali</a>
...
@include('admin.schedule-list.modal')
@endsection

@push('script')
    @include('admin.schedule-list.script')
@endpush
