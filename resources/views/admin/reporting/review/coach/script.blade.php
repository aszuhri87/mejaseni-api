        ...
        var _componentPage = function() {
            ...
            const initTable = () => {
                    init_table = $('#init-table').DataTable({
                        ...
                        ajax: {
                            type: 'POST',
                            url: "{{ url('admin/report/review/coach/dt') }}",
                        },
                        columns: [{
                                data: 'DT_RowIndex'
                            },
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        ...
                                        <span class="text-muted">${full.expertise_name }</span>
                                    </div>
                                `;
                                }
                            },
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    return `
                                    <a href="{{ url('/admin/report/review/coach/detail') }}/${data}" class="btn btn-edit btn-sm btn-clean btn-icon mr-2" title="Details">
