...
@section('content')
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
                <div class="my-title">
                    <h4 class="m-0 p-0">{{ $student->name }}</h4>
                </div>
                <div class="my-toolbar d-flex">
                    ...
                    @can('reporting_review_student_print')
                    <div class="form-group ml-1">
    ...
    @include('admin.reporting.review.student.detail.modal')
@endsection

@push('script')
    @include('admin.reporting.review.student.detail.script')
@endpush
