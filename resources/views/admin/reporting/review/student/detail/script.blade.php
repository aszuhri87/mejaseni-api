        ...
        var _componentPage = function() {
            ...
            const initTable = (classroom, star, search) => {
                    ...
                    init_table = $('#init-table').DataTable({
                        ...
                        ajax: {
                            type: 'POST',
                            url: "{{ url('admin/report/review/student/detail/dt') }}/{{ $student->id }}",
                            data: {
                                'classroom': classroom,
                                'star': star,
                                'search': search,
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        ...
                                        <span class="text-muted">${full.classroom_name}-${full.expertise_name}</span>
                                    </div>
                                `;
                                }
                            },
                            ...
                            },
                            {
                                ...
                                render: function(data, type, full, meta) {
                                    return `
                                    <a href="{{ url('/admin/report/review/student/details') }}/${data}" class="btn btn-detail btn-sm btn-clean btn-icon mr-2" title="Details">
                ...
                initAction = () => {
                    ...
                    $(document).on('click', '.btn-detail', function(event) {
                        ...
                        $('.coach').html(data.coache_name);
                        $('.rating').html(star_rating);
                        $('.text').html(data.description);

                        showModal('modal-report-review-student');
                    });
            ...
            const get_classroom = (student_id) => {
                ...
                $.ajax({
                        url: '{{ url('admin/report/review/student/detail/get-classroom') }}/' +
                            student_id,
                        type: 'GET',
                        dataType: 'json',
                    })
