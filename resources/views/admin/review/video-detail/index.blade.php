...
<div class="card mt-5" id="card-table">
    <div class="card-body">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <div class="my-title">
                <h4 class="m-0 p-0">{{$session_video->name}}</h4>
            </div>
            <div class="my-toolbar d-flex">
                ...
                @can('reporting_review_video_print')
                <div class="form-group ml-1">
                    <div class="btn-group dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="d-flex">
                                <a href="{{url('admin/report/review/video/print-excel')}}/{{Request::segment(5)}}" class="btn btn-success btn-excel ml-3">
                                    Excel
                                </a>
                                <a href="{{url('admin/report/review/video/print-pdf')}}/{{Request::segment(5)}}" class="btn btn-warning btn-pdf ml-3 mr-3">
                                    PDF
                                </a>
                            </div>
                        </div>
...
@include('admin.review.video-detail.modal')
@endsection

@push('script')
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-star-rating/4.0.6/js/star-rating.min.js" type="text/javascript"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-star-rating/4.0.6/themes/krajee-svg/theme.js"></script>
    @include('admin.review.video-detail.script')
@endpush
