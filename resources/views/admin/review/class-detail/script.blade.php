        ...
        var _componentPage = function(){
            ...
            const initTable = (rating) => {
                init_table = $('#init-table').DataTable({
                    ...
                    ajax: {
                        type: 'POST',
                        url: "{{ url('admin/report/review/class/dt') }}/{{Request::segment(5)}}",
                        data: {
                            rating:rating
                        }
                    },
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            data: "datetime",
                            render: function(data, type, full, meta){
                                return `<strong>${moment(data).format('DD MMMM YYYY')}`;
                            }
                        },
                        {
                            targets: 3,
                        ...
                        },
                        {
                            ...
                            render : function(data, type, full, meta) {
                                return `
                                    <a href="javascript:void(0)" title="Lihat" class="btn btn-sm btn-clean btn-icon mr-2 btn-see">
