<script type="text/javascript">
    var Page = function() {
        var _componentPage = function(){
            var init_table,init_select_sub_category;
            ...
            $(document).ready(function() {
                ...
                init_select_sub_category = new SlimSelect({
                    select: '#filter-sub-category'
                });
            });

            const initTable = (sub_category,rating) => {
                init_table = $('#init-table').DataTable({
                    ...
                    ajax: {
                        type: 'POST',
                        url: "{{ url('admin/report/review/video/dt') }}",
                        data:{
                    ...
                    columnDefs: [
                        ...
                        },
                        {
                            ...
                            render : function(data, type, full, meta) {
                                return `
                                    <a href="{{url('admin/report/review/video')}}/${data}" title="Lihat" class="btn btn-sm btn-clean btn-icon mr-2">
            ...
            initAction = () => {
                $(document).on('click','#btn-filter-show',function(event){
                    let sub_category = $('#filter-sub-category').val();
                    $('#card-table').show();
                    initTable(sub_category);
                });
                $(document).on('change','#select',function(event){
                    let rating = $(this).val();
                    initTable(null,rating);
                });
            ...
            getSubCategory = () => {
                ...
                .done(function(res, xhr, meta) {
                    ...
                    $('#filter-sub-category').html(element);
