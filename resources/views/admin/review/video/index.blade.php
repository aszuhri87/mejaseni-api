        ...
        <form action="form-filter">
            <div class="row">
                <div class="col-10 d-flex">
                    ...
                    <div style="width: 200px !important" class="ml-5">
                        <select id="filter-sub-category" name="filter_sub_category">

                        </select>
                    </div>
                </div>
                <div class="col-2 d-flex justify-content-end">
                    <button type="button" class="btn btn-primary" id="btn-filter-show">Tampilkan</button>
                </div>
            </div>
        </form>
    </div>
...
<div class="card mt-5" id="card-table" style="display: none">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div class="my-title">
                <h4 class="m-0 p-0">Review Video</h4>
            </div>
...
@include('admin.review.video.modal')
@endsection

@push('script')
    @include('admin.review.video.script')
@endpush
