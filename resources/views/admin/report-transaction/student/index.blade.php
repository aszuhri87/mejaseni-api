            ...
            <div class="my-toolbar d-flex">
                ...
                <div class="form-group mr-1 ml-1">
                    <div class="input-daterange input-group" id="kt_datepicker_5">
                        <input type="text" class="form-control datepicker" name="start" id="date-start" placeholder="Date Start">
                        <div class="input-group-append">
                            <span class="input-group-text">
                                <i class="la la-ellipsis-h"></i>
                            </span>
                        </div>
                        <input type="text" class="form-control datepicker" name="end" id="date-end" placeholder="Date End">
                    </div>
                </div>
