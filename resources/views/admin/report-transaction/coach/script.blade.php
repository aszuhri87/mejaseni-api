        ...
        var _componentPage = function(){
            ...
            const initTable = (date_from, date_to, status) => {
                ...
                init_table = $('#init-table').DataTable({
                    ...
                    ajax: {
                        type: 'POST',
                        url: "{{ url('admin/report/transaction/coach/dt') }}",
                        data: {
                            date_from: date_from,
                            date_to: date_to,
                            status: status
            ...
            initAction = () => {
                ...
                $(document).on('click','#btn-excel',function(event){
                    event.preventDefault();
                    $('#form-export').attr('action',"{{url('admin/report/transaction/coach/print-excel')}}");
                    $('#form-export').submit();
                });

                $(document).on('click','#btn-pdf',function(event){
                    event.preventDefault();
                    $('#form-export').attr('action',"{{url('admin/report/transaction/coach/print-pdf')}}");
                    $('#form-export').submit();
                });
            }
        };
