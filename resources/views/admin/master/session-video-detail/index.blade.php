...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div class="my-title">
                <h4 class="m-0 p-0">{{$title}} | Video</h4>
            </div>
...
<div class="card mt-5">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center">
            <div class="my-title">
                <h4 class="m-0 p-0">{{$title}} | File</h4>
            </div>
            <div class="my-toolbar d-flex">
                <div class="form-group">
                    <div class="input-icon">
                        <select class="form-control" id="file-pageLength">
                            <option value="10">10</option>
                            <option value="25">25</option>
                            <option value="50">50</option>
                            <option value="100">100</option>
                ...
                <div class="form-group ml-1">
                    <div class="input-icon">
                        <input type="text" class="form-control" id="file-search" placeholder="Search..." />
                        <span>
                            <span class="svg-icon svg-icon-primary svg-icon-2x">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                ...
                <div class="form-group ml-1">
                    <button type="button" id="file-add-btn" class="btn btn-primary btn-icon w-auto px-2 waves-effect width-md waves-light ml-1">
                        <span class="svg-icon svg-icon-white svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo10\dist/../src/media/svg/icons\Code\Plus.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <rect x="0" y="0" width="24" height="24"/>
                                <circle fill="#000000" opacity="0.3" cx="12" cy="12" r="10"/>
        ...
        <table class="table table-separate table-head-custom mb-0 pb-0" width="100%" id="file-init-table">
            <thead>
                <tr>
                    <th>No</th>
                    <th width="90%">Name</th>
...
@include('admin.master.session-video-detail.modal')
@endsection

@push('script')
    @include('admin.master.session-video-detail.script')
@endpush
