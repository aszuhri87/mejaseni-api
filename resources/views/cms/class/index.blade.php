    ...
    <div class="col-xl-8 order-1 order-xl-2 mt-3 mt-md-0">
        ...
        <div id="classroom-content">
            @if(count($sub_categories) > 0)
                @if($sub_categories[0]->is_youtube)
                    <div class="mb-3">
                        <div class="embed-responsive embed-responsive-16by9">
                        <iframe class="embed-responsive-item" frameborder="0"
                            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                            allowfullscreen src="{{ $sub_categories[0]->url }}" id="video-coach-review"></iframe>
                        </div>
                        <div class="px-4 px-md-0 px-md-0 pt-4 pt-md-0">
                        <div class="badge-left">
                            <h3 class="mt-3 ml-2">{{ $sub_categories[0]->coach ? $sub_categories[0]->coach:''}}</h3>
                        </div>
                        <p class="my-3 desc__slider-content text-justify">{{ $sub_categories[0]->description ? $sub_categories[0]->description:''}}</p>
                        </div>
                    </div>
                @else
                    <div class="content-embed__wrapper">
                        ...
                        <source id="video-coach-review" src="{{$sub_categories[0]->url}}"></source>
                        <p class="vjs-no-js">
