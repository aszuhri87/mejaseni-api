        ...
        <div class="login-wrapper p-5">
          ...
          <div class="pt-3">
            <a href="#" class="btn btn-blue row-center mt-5"><img class="img__btn-login mr-2"
                src="{{ asset('cms/assets/img/logo-facebook.svg') }}" alt="">Lanjutkan dengan Facebook</a>
            <a href="#" class="btn btn-white row-center mt-3"><img class="img__btn-login mr-2"
                src="{{ asset('cms/assets/img/logo-google.svg') }}" alt="">Lanjutkan dengan Google</a>
            ...
            <div class="row-spacearound mt-5">
              <a href="#" class="btn btn-primary w-75 row-center">Daftar Sekarang <img class="ml-2"
                  src="././assets/img/svg/Sign-in.svg" alt=""></a>
                ...
                <div class="content-embed__wrapper">
                  ...
                  <div class="px-3 px-md-0 pt-3 pt-md-0 pb-1  ">
                    <div class="badge-left">
                      <h3 class="mt-3 ml-2">Festival Seni Lukis Indonesia 202</h3>
                    </div>
