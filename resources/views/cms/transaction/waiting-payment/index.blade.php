...
<div class="row column-center">
    <div class="col-12 column-center">
        ...
        <a href="javascript:void(0);" class="btn btn-primary mb-4 row-center shadow">Batalkan Pembayaran</a>
    </div>
...
{{-- @if (session()->get('doku_type') == 'cc')
<div class="col-12">
    <iframe src="{{session()->get('doku_url')}}" id="doku-frame" style="width: 100%" height="500"></iframe>
</div>
@endif --}}
