                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            <div class="card-body pt-8">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        <a href="javascript:void(0)" class="text-dark text-hover-primary mb-1 font-size-lg" id="not-present"></a>
                ...
                <div class="card card-custom card-stretch gutter-b">
                    <div class="card-header border-0 pt-5">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label font-weight-bolder text-dark">Upcomming Class</span>
                        </h3>
                    </div>
                    <div class="card-body pt-8">
                        <div class="is_not_exist_upcoming">
                            <div style="height: 191px;" class="border rounded">
                                <div class="d-block text-center">
                                    <img src="{{asset('assets/images/not_exist_upcoming.png')}}" alt="" width="113px" height="131px" style="margin-top: 23px !important">
                                </div>
                                <div class="d-block text-center">
                                    <h5>Jadwal belum dibuat</h5>
                                </div>
                            </div>
                            <a href="{{url('student/schedule')}}" class="btn btn-primary w-100 mt-5">Buat Jadwal</a>
                        </div>
                        <div class="is_exist_upcoming" style="display: none">
                            <img src="{{asset('assets/images/thumbnail.png')}}" class="rounded" height="250px" width="100%" id="img-upcoming">
                            <h3 class="mt-5" id="title-upcoming"></h3>
            ...
            <div class="col-lg-4">
                <div class="card card-custom card-stretch gutter-b" style="height: 540px !important">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="pt-5">
                            <p class="text-center"> <span id="percent-progress-class">0</span>% sesi dari <span id="class-active">0</span> kelas aktif yang Anda miliki telah Anda hadiri.</p>
                            <a href="{{url('student/review')}}" class="btn btn-primary btn-shadow-hover font-weight-bolder w-100 py-3">Lihat Review Kelas</a>
                        </div>
                    </div>
                </div>
            </div> --}}
