    ...
    <div class="card-body">
        <div class="row">
                ...
                <div class="ml-5">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-flex mt-5" style="padding-right: 0 !important">
                            <div class="mr-5">
                                <span class="svg-icon svg-icon-primary svg-icon-3x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-02-01-052524/theme/html/demo1/dist/../src/media/svg/icons/Clothes/Crown.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div class="col-5">
                ...
                <div class="d-flex justify-content-center align-items-center" style="width: auto; height: 75%; background-color: rgb(242, 242, 242); border-radius: 0.42rem">
