        ...
        var _componentPage = function () {
            ...
            incomes_chart = () => {
                ...
                .done(function (res, xhr, meta) {
                    ...
                    var color = KTUtil.hasAttr(element, 'data-color') ? KTUtil.attr(element, 'data-color') :
                        'primary';
                    ...
                    var options = {
                        ...
                        yaxis: {
                            min: 0,
                            max: res.data.max + (res.data.max * 0.30),
                            labels: {
                                show: false,
                                style: {
                                    colors: KTApp.getSettings()['colors']['gray']['gray-500'],
            ...
            closestScheduleTable = () => {
                ...
                .done(function (res, xhr, meta) {
                    ...
                    $.each(res.data, function (index, data) {
                        ...
                        let status = ``;
                        if (moment(data.datetime) > moment() && moment(data.datetime)
                            .subtract(data.session_duration, "minutes") < moment()) {
                        ...
                        } else if (moment() > moment(data.datetime).subtract(data
                            ...
                            status +=
                                `<span class="text-danger font-weight-bolder">Cancel</span>`;
                        }
                    ...
                    columnDefs: [{
                        ...
                        },
                        {
                            ...
                            render: function (data, type, full, meta) {
                                ...
                                if (moment(full.datetime) > moment() && moment() < moment(
                                        full.datetime).subtract(full.session_duration,
                                        "minutes")) {
                                    var status = `Active`;
                                    var color = `primary`;
                                } else if (moment() > moment(full.datetime).subtract(full
                                        .session_duration, "minutes")) {
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    ` font-weight-bolder text-hover-primary mb-1 font-size-lg text-center">` +
                                    status + `</a>
                                        </div>
                                    </div>
                                `;
                ...
                $(document).on('click', '.review-last-class-btn', function (event) {
                    ...
                    $.ajax({
                        ...
                        .done(function (res, xhr, meta) {
                            ...
                            $('#form-review-last-class').attr('action',
                                "{{ url('coach/dashboard/review-last-class') }}/" + res.data
                                .detail_schedules.id + '&' + student_schedule_id);
                            ...
                            $('.date').html(moment(res.data.detail_schedules.datetime).format(
                                'DD MMMM YYYY'));
                            $('.time').html(moment(res.data.detail_schedules.datetime).format(
                                'HH:MI'));
            ...
            getBalance = () => {
                $.ajax({
                    ...
                    .done(function (res, xhr, meta) {
                        ...
                        $('.d-amount').html('Rp. ' + numeral(res.data.amount + res.data.balance).format(
                            '0,0'))
