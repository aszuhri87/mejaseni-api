...
<div class="card mt-5" id="card-assignment" style="display: none; min-height: 75vh;">
    ...
    <div class="card-body">
        <div class="row" id="assignment-list">
    ...
    @include('coach.exercise.assignment.modal')
@endsection

@push('script')
    @include('coach.exercise.assignment.script')
@endpush
