...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-head-custom table-head-bg table-borderless table-vertical-center" width="100%" id="init-table">
                    <thead>
    ...
    @include('coach.withdraw.modal')
@endsection

@push('script')
    @include('coach.withdraw.script')
@endpush
