                    ...
                    <div class="login-form">
                        ...
                        <form class="form" id="kt_login_signin_form" method="POST"  autocomplete="off">
                            ...
                            <div class="pb-5 pb-lg-10">
                                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Selamat,<br>pendaftaran telah berhasil</h3>
                                <p class="text-muted">Silakan verivikasi email anda.</p>
                            </div>
