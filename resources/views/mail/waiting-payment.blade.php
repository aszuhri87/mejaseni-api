...
<head>
	...
	<title>Mejaseni Notification</title>
</head>
										...
										<td>
											<table role="presentation" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <p>
                                                            Menunggu pembayaran Nomor Invoice <b>{{$notification['number']}}</b> sebelum <b>{{$notification['due_date']}}</b> <br><br>
                                                            Total tagihan : <b>Rp {{number_format($notification['total'])}}</b> <br>
                                                            Metode Pembayaran : <b>{{$notification['payment_chanel']}}</b> <br>
                                                            Kode Pembayaran : <b>{{$notification['va_number']}}</b> <br>
                                                        </p>
                                                    </tr>
                                                </tbody>
                                            </table>
